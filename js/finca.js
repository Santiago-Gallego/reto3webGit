...
let url = "http://129.151.103.188:8082/api/Farm/all"
...
function editar(id) {
  ...
  url = "http://129.151.103.188:8082/api/Farm";
...
function eliminar(id) {
  //1 crear un objeto XMLHttpRequest
  let peticion = new XMLHttpRequest();
  let url = "http://129.151.103.188:8082/api/Farm";
...
function guardarNuevo() {
  ...
  url = "http://129.151.103.188:8082/api/Farm/save";
...
function guardarEditar() {
  ...
  url = "http://129.151.103.188:8082/api/Farm/update";
...
function guardarBorrar() {
  ...
  */
  ...
  url = "http://129.151.103.188:8082/api/Farm/delete";
...
function traerdatos() {
  //1 crear un objeto XMLHttpRequest
  let peticion = new XMLHttpRequest();
  url = "http://129.151.103.188:8082/api/Farm/all";
    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      for (let i in respuesta) {
        ...
        registros +=
          ...
          id +
          ')" disabled>Modificar Finca</button>\
                            <button class="btn btn-outline-dark" onclick="eliminar(' +
          id +
          ')" disabled>Borrar Finca</button>\
                        </td>\
                        </tr>';
      }
...
function traecategorias(){
  //1 crear un objeto XMLHttpRequest
  let peticion = new XMLHttpRequest();
  url = "http://129.151.103.188:8082/api/Category/all";
  let id;
  let nombre;
  let respuesta;
  /*2 propiedad onreadystatechange asigna a una funcion
